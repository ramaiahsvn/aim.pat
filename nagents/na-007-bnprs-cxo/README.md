# na-007-bnprs-cxo — BNPRS CXO Agents

AI agents serving BNPRS C-level executives. Named after the five Pandava brothers.

Each agent follows the standard `nagent-template/` structure (01–08 folders).
...
|------------|--------------------------------------|
| Group ID   | na-007                               |
| Folder     | nagents/na-007-bnprs-cxo             |
| Domain     | CXO (C-level executive) AI agents    |
| Max agents | 255                                  |
