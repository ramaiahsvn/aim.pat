...
- **Name**: trp1004-bnagent
- **Code**: 017
- **Group**: na-009-bnprs-products
- **Role**: TRP BNAgent Product Agent — AI Agent Platform (aim.pat)
- **Domain**: ai-agent-platform, nagent, aim-pat, bnagent, TRP1004
- **Version**: 1.0.0
