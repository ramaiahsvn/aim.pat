...
- **Role**: BPR bPass Product Agent — Issuer Controlled Biometric Authentication (ICBA)
- **Domain**: biometric-authentication, icba, bpass, smart-card, BPR1005
- **Version**: 1.0.0
